...
import com.mycompany.myapp.StudiReApp;
...
public class StudentResourceIntTest {
    ...
    public void createStudent() throws Exception {
        ...
        assertThat(testStudent.getAdresse()).isEqualTo(DEFAULT_ADRESSE);
    ...
    public void updateStudent() throws Exception {
        ...
        assertThat(testStudent.getAdresse()).isEqualTo(UPDATED_ADRESSE);
